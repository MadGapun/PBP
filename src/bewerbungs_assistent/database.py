...
class Database:
    ...
    def __init__(self, db_path: Optional[Path] = None):
        ...
        # A28 (#900): eine Connection JE THREAD statt einer geteilten.
        # Die alte geteilte Connection (check_same_thread=False, ein
        # Objekt fuer alle Threads) liess Transaktionen zweier Threads
