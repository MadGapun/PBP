...
EINSTELLUNG = frozenset({
    ...
    "automatik_status", "custom_quelle_hinzufuegen", "custom_quelle_loeschen",
    "custom_quellen_anzeigen", "daten_bereiche_anzeigen",
    "daten_bereiche_leeren", "elwosa_pause", "elwosa_tonfall",
    "expertenmodus_setzen", "fahrstrecken_verwalten", "ki_features_lesen",
    "ki_features_setzen", "komponente_installieren", "komponente_pfad_setzen",
    "komponenten_status", "kontakt_kategorie_anlegen",
...
KURZ = {
    ...
    "profil_erstellen": (
        ...
        "die dabei uebernommen wurden, und den nächsten Schritt — meist "
