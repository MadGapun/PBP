...
def format_befund(dateiname: str, text: str) -> dict | None:
    ...
    if office_text.kann_lesen(dateiname):
        ...
        return {"format": "leer", "grund": "Die Datei enthält keinen auslesbaren Text."}
    return None
...
def _run_auto_actions_inner(now: str) -> dict:
    ...
    # (Linien-Unterschied: der Snapshot-Backfill (#688/B24) existiert nur
    # in der 1.8-Linie — hier bewusst nicht mitgewandert.)
