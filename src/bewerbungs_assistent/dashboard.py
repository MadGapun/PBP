...
async def api_meetings_export_ics():
    ...
    v1.8.0-beta.3 (J4.1/#481): Kern nach services/ics_service.py extrahiert
    — jetzt mit RFC-5545-Escaping (Kommas/Semikolons/mehrzeilige Notizen
    zerbrachen vorher die Datei) und 75-Oktett-Line-Folding. Gleicher Kern
    wie das MCP-Tool `termine_ics_exportieren`.
    """
    from .services.ics_service import build_meetings_ics
    ics_content, _count = build_meetings_ics(_db)
