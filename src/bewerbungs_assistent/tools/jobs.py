...
""".strip()
    ...
    def stellenbeschreibung_nachladen(stellen_hash: str) -> dict:
        ...
        # #952: Das ist jetzt der VOLLE Text — vorher wurde ein bei 2000
        # Zeichen gekappter Text als unveraenderlicher Snapshot
        # festgeschrieben, also der halbe Text auf Dauer zementiert.
        ...
        * **beide** — beides in einem Lauf.
        ...
        with httpx.Client(
            ...
            for job in auswahl[:max(1, int(max_stellen or 25))]:
                ...
                db.set_description_snapshot_if_empty(
                    job.get("hash"), text, "nachladen")
                gewachsen.append({
