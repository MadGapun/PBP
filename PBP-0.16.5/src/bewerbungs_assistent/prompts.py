...
→ Erst dann: "Super, dein Profil ist fertig! Du kannst es jederzeit
   spaeter noch anpassen. Im Dashboard (http://localhost:5173) siehst du
...
📊 BEWERBUNGS-TRACKING
  Dashboard auf http://localhost:5173 mit Uebersicht aller Bewerbungen,
...
8. Biete an: "Moechtest du noch Dokumente hochladen? Das geht im Dashboard (http://localhost:5173)."
"""
