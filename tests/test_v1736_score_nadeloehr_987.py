...
def test_987_alle_wege_bauen_die_kriterien_aus_demselben_nadeloehr():
    ...
    # `dashboard.py` (Plugin-Ingest) und `newsletter_service.py` gibt es
    # nur in der 1.8-Linie. Ein Waechter, der auf der anderen Linie an
    # einem fehlenden Pfad scheitert, prueft dort gar nichts mehr —
    # deshalb ueberspringen statt annehmen (DoD 8c).
    dateien = [
    ...
    assert geprueft >= 2, "Der Waechter hat nichts geprueft."
