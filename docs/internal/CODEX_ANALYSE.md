...
`src/bewerbungs_assistent/dashboard.py` implementiert eine lokale FastAPI-Oberflaeche auf Port 5173. Die API ist pragmatisch gehalten, direkt an der DB ausgerichtet und deckt Profilverwaltung, Dokumente, Jobs, Bewerbungen und Profile-Switching ab.
